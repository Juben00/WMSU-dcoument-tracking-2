        ...
        >
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="mx-auto max-w-md rounded bg-white dark:bg-gray-900 p-6 max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
                    <Dialog.Title className="text-lg font-medium mb-4 text-gray-900 dark:text-gray-100">Return Document Form</Dialog.Title>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end gap-2 mt-6">
                            <Button type="button" variant="outline" onClick={onClose} disabled={processing} className="dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800">
                                Cancel
                            </Button>
                            <Button type="submit" variant="default" disabled={processing || !comments.trim()} className="dark:bg-orange-600 dark:hover:bg-orange-700 dark:text-white">
                                Return Document
                            </Button>
                        </div>
                    </form>
